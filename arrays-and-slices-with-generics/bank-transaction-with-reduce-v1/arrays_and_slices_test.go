...
import (
	...
	arr "github.com/ArtusC/go-with-tests/arrays-and-slices-with-generics/bank-transaction-with-reduce-v1"
)
...
func TestBankTransaction(t *testing.T) {
	...
	arr.AssertEqual(t, arr.BalanceFor(transactions, "Amanda"), 100)
	arr.AssertEqual(t, arr.BalanceFor(transactions, "Artus"), -75)
	arr.AssertEqual(t, arr.BalanceFor(transactions, "Paulo"), -25)
}
